...
public class VentanaLvl2 extends javax.swing.JFrame implements MouseListener {
	...
	private javax.swing.JLabel Ldios22;
	private javax.swing.JLabel Ldios23;
	private javax.swing.JLabel Ldios24;
	private javax.swing.JLabel Ldios25;
	private javax.swing.JLabel Ldios26;
	private javax.swing.JLabel Ldios27;
	private javax.swing.JLabel Ldios28;
	private javax.swing.JLabel Ldios29;
	private javax.swing.JLabel Ldios30;
	private javax.swing.JLabel Ldios31;
	private javax.swing.JLabel Ldios32;
	private javax.swing.JLabel Ldios33;
	private javax.swing.JLabel Ldios34;
	private javax.swing.JLabel Ldios35;
	private javax.swing.JLabel Ldios36;
	private javax.swing.JLabel Ldios37;
	...
	int[] NImagenes = new int[34];
	JLabel[] LImagenes = new JLabel[34];
	int[] Control = new int[17];

	int[] Parejas = new int[34];
	int[] NClick = new int[34];// Arreglo que permitir� controlar los
...
setVisible(true);
	...
	private void initComponents() {
		...
		Ldios21.setBounds(5, 400, 100, 100);

		Ldios22 = new JLabel();
		Ldios22.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Smileima/quien.jpg")));
		Ldios22.setBounds(113, 400, 100, 100);

		Ldios23 = new JLabel();
		Ldios23.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Smileima/quien.jpg")));
		Ldios23.setBounds(220, 400, 100, 100);

		Ldios24 = new JLabel();
		Ldios24.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Smileima/quien.jpg")));
		Ldios24.setBounds(324, 400, 100, 100);

		Ldios25 = new JLabel();
		Ldios25.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Smileima/quien.jpg")));
		Ldios25.setBounds(424, 400, 100, 100);

		Ldios26 = new JLabel();
		Ldios26.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Smileima/quien.jpg")));
		Ldios26.setBounds(424, 300, 100, 100);

		Ldios27 = new JLabel();
		Ldios27.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Smileima/quien.jpg")));
		Ldios27.setBounds(424, 300, 100, 100);

		Ldios28 = new JLabel();
		Ldios28.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Smileima/quien.jpg")));
		Ldios28.setBounds(424, 300, 100, 100);

		Ldios29 = new JLabel();
		Ldios29.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Smileima/quien.jpg")));
		Ldios29.setBounds(424, 300, 100, 100);

		Ldios30 = new JLabel();
		Ldios30.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Smileima/quien.jpg")));
		Ldios30.setBounds(424, 300, 100, 100);

		Ldios31 = new JLabel();
		Ldios31.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Smileima/quien.jpg")));
		Ldios31.setBounds(424, 300, 100, 100);

		Ldios32 = new JLabel();
		Ldios32.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Smileima/quien.jpg")));
		Ldios32.setBounds(424, 300, 100, 100);

		Ldios33 = new JLabel();
		Ldios33.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Smileima/quien.jpg")));
		Ldios33.setBounds(424, 300, 100, 100);

		Ldios34 = new JLabel();
		Ldios34.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Smileima/quien.jpg")));
		Ldios34.setBounds(424, 300, 100, 100);

		Ldios36 = new JLabel();
		Ldios36.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Smileima/quien.jpg")));
		// NOI18N
		Ldios36.setBounds(113, 300, 100, 100);

		Ldios36.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes Fondo/12.jpg")));
		Ldios36.setBounds(0, 0, 750, 600);
		JPDioses = new JPanel();
		...
		JPDioses.add(Ldios22);
		JPDioses.add(Ldios23);
		JPDioses.add(Ldios24);
		JPDioses.add(Ldios25);
		JPDioses.add(Ldios26);
		JPDioses.add(Ldios27);
		JPDioses.add(Ldios28);
		JPDioses.add(Ldios29);
		JPDioses.add(Ldios30);
		JPDioses.add(Ldios31);
		JPDioses.add(Ldios32);
		JPDioses.add(Ldios33);
		JPDioses.add(Ldios34);
	...
	private void inicializaArregloImagenes() {
		...
		LImagenes[20] = Ldios21;
		LImagenes[21] = Ldios22;
		LImagenes[22] = Ldios23;
		LImagenes[23] = Ldios24;
		LImagenes[24] = Ldios25;
		LImagenes[25] = Ldios26;
		LImagenes[26] = Ldios27;
		LImagenes[27] = Ldios28;
		LImagenes[28] = Ldios29;
		LImagenes[29] = Ldios30;
		LImagenes[30] = Ldios31;
		LImagenes[31] = Ldios32;
		LImagenes[32] = Ldios33;
		LImagenes[33] = Ldios34;
